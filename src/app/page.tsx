  ...
  return (
    <div className="w-full">
        ...
        <div className="w-full flex  flex-col items-center justify-center p-10">
            ...
            <div className="mt-5">
                I am currently Worked at <a href=""><b>Banking Company</b></a> as Backend Developer
            </div>
            <div className="mt-5">
                Previously a Founder of <a href=""><b>[Redacted App]</b></a> Maintaining a database of 200 digital products, such as game vouchers, credit, electricity tokens
            </div>

            <div className="mt-5">
                And I have worked as a Frontend Developer at <b>ProSpace</b>, and <b>Rushowl Singapore</b>
            </div>
